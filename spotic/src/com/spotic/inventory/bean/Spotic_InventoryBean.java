...
public class Spotic_InventoryBean {
	...
	private String inventory_state;		// 状态[
										// 11、准备销售 12、开始销售 13、销售完成 14、 销售异常；
										// 21、准备供货 22、开始供货 23、供货完成 24、供货异常；
										// 31、准备上货 32、开始上货 33、上货完成 34、上货异常；
										//]
